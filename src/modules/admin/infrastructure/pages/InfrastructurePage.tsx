...
import { Server, Activity, HardDrive, Cpu, MemoryStick, Users, Camera } from 'lucide-react'
...
export function InfrastructurePage() {
  ...
  const filteredServers = INFRA_SERVERS.filter((server) => {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">Monitoramento de servidores e recursos do sistema</p>
      </div>
      ...
      <Card className="border-0 bg-white shadow-sm ring-1 ring-slate-100">
        <CardContent className="p-4">
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="mb-2 block text-xs font-medium text-slate-500">Tipo de Servidor</label>
              <Select
                value={typeFilter}
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {filteredServers.map((server) => {
          ...
          return (
            <Card key={server.id} className="border-0 bg-white shadow-sm ring-1 ring-slate-100">
      ...
      {filteredServers.length === 0 && (
        <Card className="border-0 bg-white shadow-sm ring-1 ring-slate-100">
          <CardContent className="py-16 text-center">
            ...
            <p className="mt-4 text-sm text-slate-500">Nenhum servidor encontrado com os filtros selecionados</p>
          </CardContent>
        </Card>
      )}
    </div>
